...
export const getFriends = async (): Promise<User[]> => {
  const response = await axiosClient.get<User[]>(USER_ENDPOINTS.LIST_FRIENDS);
...
export const sendFriendRequest = async (targetUserId: string): Promise<void> => {
  await axiosClient.post(USER_ENDPOINTS.FRIEND_REQUEST, { targetUserId });
};
...
export const acceptFriendRequest = async (requesterId: string): Promise<void> => {
  await axiosClient.post(USER_ENDPOINTS.FRIEND_ACCEPT, { requesterId });
};
...
export const removeFriend = async (friendId: string): Promise<void> => {
  await axiosClient.delete(USER_ENDPOINTS.REMOVE_FRIEND(friendId));
};
...
export const getBlockedUsers = async (): Promise<User[]> => {
  const response = await axiosClient.get<User[]>(USER_ENDPOINTS.BLOCKS);
  return response.data;
};
...
export const blockUser = async (targetUserId: string): Promise<void> => {
  await axiosClient.post(USER_ENDPOINTS.BLOCKS, { targetUserId });
};
...
export const unblockUser = async (targetUserId: string): Promise<void> => {
  await axiosClient.delete(USER_ENDPOINTS.UNBLOCK(targetUserId));
};
